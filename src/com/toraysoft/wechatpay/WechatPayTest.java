...
public class WechatPayTest {
	...
	private static final String TAG = "WechatPayTest";

	static WechatPayTest instance;
	...
	public static final String APP_ID = "wx6745aaa6e2878f99";
	...
	private static final String APP_SECRET = "c999389f39704e19fe3e572b265a6c10";
	public static final String PARTNER_ID = "1222813501";
	private static final String PARTNER_KEY = "b2965f346588ce223ef8918ba6fbe252";

	public WechatPayTest(Activity context) {
		this.context = context;
		api = WXAPIFactory.createWXAPI(context, APP_ID);
	}

	public static WechatPayTest get(Activity context) {
		if (instance == null) {
			instance = new WechatPayTest(context);
		}
		return instance;
	}
	...
	private class GetAccessTokenTask extends
		...
		protected void onPostExecute(GetAccessTokenResult result) {
			if (result.localRetCode == LocalRetCode.ERR_OK) {
				...
				// R.string.get_access_token_succ, Toast.LENGTH_LONG).show();
				...
				// result.localRetCode.name()), Toast.LENGTH_LONG).show();
			}
		}
